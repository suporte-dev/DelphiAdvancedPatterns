...
Esta unit utiliza o framework **DUnit** para testar a unidade `ResultMatching`. A unit verifica o comportamento correto dos métodos e operadores implícitos, além de testar o sistema de Pattern Matching implementado.
